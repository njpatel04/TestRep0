   ...
   '-------------------------------------------------------------------------------------------------------------
    ...
    For t = 2 To Row
        ...
        Else
            ...
            TotalStock = 0 'TotalStock volume is brought back to 0 so it can start volume calculation for next ticker in the table
            
        End If
                                      
    Next t
 
    Dim Max, Min, HiVol, YCRow, VolRow As Double
